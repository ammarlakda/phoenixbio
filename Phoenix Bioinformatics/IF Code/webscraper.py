...
# maybe try with this https://www.ncbi.nlm.nih.gov/gene/?term=Phyb (does genes only)
...
#Need to clean article list for null values 
    clean = filter(None, articles_list)
